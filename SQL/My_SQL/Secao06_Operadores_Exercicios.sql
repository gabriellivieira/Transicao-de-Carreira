...
-- OBS: Criação do banco para a atividade ao final das Querys
...
-- 02) O gestor de marketing pediu a lista das funcionarias (AS) = FEMININO que trabalhem no departamento de filmes 
-- ou no departamento lar. Ele necessita enviar um email para as colaboradoras desses dois setores. OR + AND *
...
/* Criando a Database do exercicio */
