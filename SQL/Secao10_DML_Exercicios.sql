...
/* Cadastro de endereco para cada cliente*/
...
--/--
-- Relatório para todos os clientes

-- 01)Relatorio geral de todos os clientes (Telefone e Endereco)
...
-- 04) Quantidade de homens e mulheres

SELECT COUNT(*) AS QUANTIDADE, SEXO
FROM CLIENTE
GROUP BY SEXO;

-- 05) ID's e emails das mulheres que moram no centro do RJ e não tenham celular
...
-- 06) para uma campanha de produtos de beleza, o comercial solicitou um relatório com o 
